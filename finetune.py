...
def make_prompt(instruction):
    prompt = f"""Dưới đây là một chỉ dẫn để mô tả tác vụ. Hãy viết một phản hồi thích hợp. 
...
#### NEW PROMPT FOR SMOOTHER ####
# def make_prompt(question, answer):
#     INSTRUCTION_KEY = "### Instruction:"
#     RESPONSE_KEY = "### Response:"
#     INTRO_BLURB = "Hãy viết một phản hồi thích hợp cho chỉ dẫn dưới đây."
...
#     example = f"Câu hỏi: {question}. Câu trả lời ngắn: {answer}. Kết hợp câu hỏi và câu trả lời ngắn thành một câu hoàn chỉnh."
...
#     response = data_point["extended_answer"].strip()
#     return f"{make_prompt(question, answer)}{response}"
#### NEW PROMPT FOR SMOOTHER ####
